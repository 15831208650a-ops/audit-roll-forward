...
class RollForwardApp(QWidget):
    ...
    def stylesheet(self):
        return f"""
            ...
            QWidget#Header {{
                background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #121826, stop:1 #0B0F1A);
    ...
    def init_ui(self):
        ...
        self.root_scroll.viewport().setStyleSheet(f"background: {EY_BLACK};")
    ...
    def create_header(self):
        ...
        header.setStyleSheet(
            f"QWidget#Header {{ background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #121826, stop:1 {EY_BLACK}); border: 1px solid {EY_BORDER}; border-radius: 8px; }}"
        )
        ...
        badge.setStyleSheet(
            f"color: {EY_MUTED}; background: {EY_PANEL_ALT}; padding: 6px 10px; "
            f"font-weight: 700; border-radius: 4px; border: 1px solid {EY_BORDER};"
        )
